    ...
    if request.method == "POST":
        ...
        if action == "Delete current host":
            ...
            try:
                ...
                return HttpResponseNotFound("<h2>No connection is detected</h2>")
        ...
        if action == "Move/Download":
            ...
            try:
                ...
                server_op.load_directory(path)
                data = server_op.get_files()
                message = "File was downloaded to " + path_save + filename
